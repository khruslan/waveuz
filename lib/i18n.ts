...
const extraTranslations: TranslationTable = {
  ...
  ru: {
    ...
    "hero.title.1": "Создаём",
    "hero.title.2": "Интеллект",
    "hero.title.3": "Для бизнеса",
  ...
  uz: {
    ...
    "hero.title.1": "Biz quramiz",
    "hero.title.2": "Intellekt",
    "hero.title.3": "Biznes uchun",
